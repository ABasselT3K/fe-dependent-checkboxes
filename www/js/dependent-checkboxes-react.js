...
var DependentCheckboxes = (function (_React$Component) {
    _inherits(DependentCheckboxes, _React$Component);

    function DependentCheckboxes(props) {
        _classCallCheck(this, DependentCheckboxes);

        _get(Object.getPrototypeOf(DependentCheckboxes.prototype), 'constructor', this).call(this, props);
        this.state = {
            checkAll: {
                checked: false
            },
            categories: [{
                items: [{ checked: false }, { checked: false }, { checked: false }, { checked: false }, { checked: false }, { checked: false }, { checked: false }, { checked: false }, { checked: false }, { checked: false }]
            } // ,
            // {
    ...
    _createClass(DependentCheckboxes, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                'div',
                null,
                _react2['default'].createElement(CheckAll, { checked: this.state.checkAll.checked }),
                this.state.categories.map(function (category, index) {
                    return _react2['default'].createElement(Category, { index: index + 1, items: category.items, key: index + 1 + 'cat' });
                })
            );
        }
    }]);
...
var CheckAll = (function (_React$Component2) {
    _inherits(CheckAll, _React$Component2);

    function CheckAll() {
        _classCallCheck(this, CheckAll);

        _get(Object.getPrototypeOf(CheckAll.prototype), 'constructor', this).apply(this, arguments);
    }
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    'label',
                    { className: 'checkbox' },
                    _react2['default'].createElement('input', { type: 'checkbox', className: 'check-all', defaultChecked: this.props.checked, onChange: this.handleChange }),
                    ' Check all'
                )
            );
        }
...
var Category = (function (_React$Component3) {
    _inherits(Category, _React$Component3);
    ...
    _createClass(Category, [{
        ...
        value: function handleChange(index, e) {
            console.log(_react2['default'].findDOMNode(this));
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    'label',
                    { className: 'checkbox' },
                    _react2['default'].createElement('input', { type: 'checkbox', 'data-group': 'cat' + this.props.index }),
                    'Category ',
                    this.props.index
                ),
                _react2['default'].createElement(
                    ...
                    this.props.items.map(function (item, index) {
                        return _react2['default'].createElement(
                            'li',
                            { key: _this.props.index + '-' + index },
                            _react2['default'].createElement(
                                'label',
                                { className: 'checkbox' },
                                _react2['default'].createElement('input', { type: 'checkbox', 'data-category': 'cat' + _this.props.index, onChange: _this.handleChange.bind(_this, index) }),
                                'Item'
                            )
                        );
                    })
...
_react2['default'].render(_react2['default'].createElement(DependentCheckboxes, null), document.getElementById('dependent-checkboxes-placeholder'));
